...
function Register() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      navigate("/login", { replace: true, state: { success: "Registrasi berhasil, silakan login" } })
    } catch (requestError) {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-neutral-50 px-4">
      <div className="w-full max-w-md rounded-xl border border-neutral-200 bg-white p-6 shadow-sm">
        ...
        <p className="mb-6 text-sm text-neutral-600">Register to start managing your tasks.</p>
